...
public class Spec1ObjectConfigParser implements XConfigParser<FormBasedObjectConfig> {
    ...
    public FormBasedObjectConfig parse(JsonObject configJson) {
        ...
        config.setKey(ConfigUtils.getRequiredString(configJson, "objectKey"));
        config.setCode(ConfigUtils.getRequiredString(configJson, "objectCode"));
        config.setTitle(ConfigUtils.getRequiredString(configJson, "objectName"));
        config.setDescription(ConfigUtils.getString(configJson, "description"));
        config.setTableName(ConfigUtils.getRequiredString(configJson, "tableName"));
        config.setPrimaryFieldKey(ConfigUtils.getRequiredString(configJson, "primaryFieldKey"));
