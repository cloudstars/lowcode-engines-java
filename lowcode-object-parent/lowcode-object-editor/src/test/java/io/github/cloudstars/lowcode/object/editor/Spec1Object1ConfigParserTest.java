...
public class Spec1Object1ConfigParserTest {
    ...
    @Test
    public void test() {
        JsonObject configJson = JsonUtils.loadJsonObjectFromClasspath("object1-spec-1.json");
        FormBasedObjectConfig config = this.configParser.parse(configJson);
        JsonObject expectedConfigJson = JsonUtils.loadJsonObjectFromClasspath("object1-spec-2.json");
