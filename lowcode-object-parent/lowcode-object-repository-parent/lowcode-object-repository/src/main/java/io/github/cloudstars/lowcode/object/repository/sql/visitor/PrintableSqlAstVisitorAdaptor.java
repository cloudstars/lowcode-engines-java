...
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.identifier.SqlIdentifierExpr;
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.identifier.SqlMethodInvokeExpr;
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.identifier.SqlPropertyExpr;
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.literal.*;
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.op.SqlBinaryOpExpr;
 ...
 * @author clouds
 */
public class PrintableSqlAstVisitorAdaptor extends SqlAstVisitorAdaptor implements PrintableVisitor {
    ...
    public PrintableSqlAstVisitorAdaptor(Appendable appender) {
    ...
    protected void printExpr(SqlExpr x) {
        ...
        } else if (clazz == SqlDecimalExpr.class) {
            this.visit((SqlDecimalExpr) x);
