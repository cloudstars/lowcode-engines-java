...
import io.github.cloudstars.lowcode.object.repository.sql.ast.SqlLimit;
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.SqlExpr;
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.identifier.SqlAllColumnExpr;
...
import io.github.cloudstars.lowcode.object.repository.sql.ast.expr.op.SqlCaseExpr;
import io.github.cloudstars.lowcode.object.repository.sql.ast.statement.*;
...
public class SqlSelectParser extends SqlExprParser {
     ...
     * @return
     */
    public SqlSelect select(boolean isSubQuery) {
