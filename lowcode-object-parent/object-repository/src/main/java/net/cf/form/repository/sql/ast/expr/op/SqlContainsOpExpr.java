 ...
 * @author clouds
 */
public final class SqlContainsOpExpr extends AbstractNotableExpr implements SqlReplaceable {
    ...
    private SqlContainsOption option;


    public SqlContainsOpExpr() {
    }

    public SqlContainsOpExpr(SqlExpr left) {
        this.setLeft(left);
    }

    public SqlContainsOpExpr(String left, String... values) {
    ...
    public SqlContainsOpExpr(SqlExpr left, boolean not) {
        this.setLeft(left);
        this.not = not;
    }
