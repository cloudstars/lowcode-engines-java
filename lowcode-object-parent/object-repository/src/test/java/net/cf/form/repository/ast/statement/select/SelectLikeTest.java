...
public class SelectLikeTest extends AbstractSqlTest {

    public SelectLikeTest() {
        super("sql/select/SelectLike.json");
    }
    ...
    public void testSelectLike() {
        String sql = this.sqlMap.get("SELECT_LIKE");
        assert (sql != null);
        ...
        // 与 Druid 的 AST 作对比 (Druid把escape当作是一种二元操作)
        ...
        Assert.assertFalse(SqlTestUtils.equals(stmt0, druidStmts.get(0)));
    }
