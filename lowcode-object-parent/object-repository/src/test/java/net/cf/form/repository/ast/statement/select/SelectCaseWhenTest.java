...
public class SelectCaseWhenTest extends AbstractSqlTest {

    public SelectCaseWhenTest() {
        super("sql/select/SelectCaseWhen.json");
    }
    ...
    public void testSelectCaseWhen() {
        String sql = this.sqlMap.get("SELECT_CASE_WHEN");
        assert (sql != null);
