...
public class SubFormObjectFieldConfig extends AbstractObjectFieldConfig {
    ...
    public SubFormObjectFieldConfig() {
    }

    public SubFormObjectFieldConfig(JsonObject configJson) {
        super(configJson);
