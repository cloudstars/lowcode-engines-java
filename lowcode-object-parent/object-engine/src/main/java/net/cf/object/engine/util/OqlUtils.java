...
public class OqlUtils {
   ...
   private static List<String> SQL_METHOD_NAMES = Arrays.asList("NOW", "LTRIM", "CONCAT", "SUBSTRING", "TRIM", "RTRIM", "YEAR", "MONTH", "DAY", "LENGTH", "DATE", "TIMESTAMP", "DATE_FORMAT", "IFNULL");
