...
public class SelectTravelSelfSimpleWhereStmtTest extends AbstractOqlTest implements SelectTravelSelfSimpleWhereTest {

    public SelectTravelSelfSimpleWhereStmtTest() {
        super(OQL_FILE_PATH);
    }
