...
import net.cf.object.engine.oql.testcase.Hobby;
...
public class InsertHobbyStmtTest extends AbstractOqlTest implements InsertHobbyTest {
    ...
    public void testInsertHobby() {
        ...
        XObject object = ObjectTestResolver.resolveObject(Hobby.NAME);
        ...
        assert (osExpr instanceof SqlIdentifierExpr && Hobby.NAME.equals(((SqlIdentifierExpr) osExpr).getName()));
