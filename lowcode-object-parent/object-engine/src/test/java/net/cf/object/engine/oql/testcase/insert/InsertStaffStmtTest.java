...
public class InsertStaffStmtTest extends AbstractOqlTest implements InsertStaffTest {

    public InsertStaffStmtTest() {
        super(OQL_FILE_PATH);
    }
    ...
    public void testInsertStaff() {
        ...
        assert (osExpr instanceof SqlIdentifierExpr && "Staff".equals(((SqlIdentifierExpr) osExpr).getName()));
