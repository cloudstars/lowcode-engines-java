...
public class SelectTravelByTripsExistStmtTest extends AbstractOqlTest implements SelectTravelByTripsExistsTest {

    public SelectTravelByTripsExistStmtTest() {
        super(OQL_FILE_PATH);
    }

    @Test
    @Override
    public void testSelectTravelByTripsLike() {
        OqlInfo oqlInfo = this.oqlInfos.get(OQL_SELECT_TRAVEL_BY_TRIPS_LIKE);
