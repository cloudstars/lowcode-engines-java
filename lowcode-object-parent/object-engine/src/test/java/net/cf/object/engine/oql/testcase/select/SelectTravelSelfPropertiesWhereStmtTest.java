...
public class SelectTravelSelfPropertiesWhereStmtTest extends AbstractOqlTest implements SelectTravelSelfPropertiesWhereTest {

    public SelectTravelSelfPropertiesWhereStmtTest() {
        super(OQL_FILE_PATH);
    }
