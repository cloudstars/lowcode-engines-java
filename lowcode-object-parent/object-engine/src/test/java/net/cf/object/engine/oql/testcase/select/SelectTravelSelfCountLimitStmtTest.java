...
public class SelectTravelSelfCountLimitStmtTest extends AbstractOqlTest implements SelectTravelSelfCountLimitTest {

    public SelectTravelSelfCountLimitStmtTest() {
        super(OQL_FILE_PATH);
    }
