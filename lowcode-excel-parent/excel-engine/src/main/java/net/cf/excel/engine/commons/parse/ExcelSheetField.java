...
public class ExcelSheetField {
    ...
    public ExcelSheetField(SingleExcelField singleParseField, ExcelSheetField parentField) {
    ...
    public ExcelSheetField(ExcelFieldGroup parseFieldGroup, List<ExcelSheetField> subFields) {
