...
public class VariableDataSourceLoader<V extends AbstractValueType<C, D>, C extends XValueTypeConfig, D extends Object> extends AbstractDataSourceLoader<VariableDataSourceConfig<C>, V, C, D> {
    ...
    @Override
    public D loadData() {
        String variableName = this.dataSourceConfig.getVariable();
