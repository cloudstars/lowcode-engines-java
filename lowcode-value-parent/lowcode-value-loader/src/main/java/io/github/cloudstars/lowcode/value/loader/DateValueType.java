...
import io.github.cloudstars.lowcode.value.type.DateValueTypeConfig;
...
public class DateValueType extends AbstractValueType<DateValueTypeConfig, Date> {

    // 默认的日期格式
    private static final String DEFAULT_FORMAT = "yyyy-MM-dd HH:mm:ss.SSS";

    public DateValueType(DateValueTypeConfig valueTypeConfig) {
