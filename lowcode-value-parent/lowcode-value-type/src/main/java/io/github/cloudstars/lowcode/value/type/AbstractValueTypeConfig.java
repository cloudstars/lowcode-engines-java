...
public abstract class AbstractValueTypeConfig extends AbstractTypedConfig implements XValueTypeConfig {
    ...
    public AbstractValueTypeConfig(JsonObject configJson) {
        ...
        this.setType(this.getClass().getAnnotation(ValueTypeConfigClass.class).name());
        this.required = ConfigUtils.getBoolean(configJson, ATTR_REQUIRED);
        this.defaultValue = ConfigUtils.get(configJson, ATTR_DEFAULT_VALUE);
    }
    ...
    public JsonObject toJson() {
        ...
        ConfigUtils.put(configJson, ATTR_REQUIRED, this.required);
        ConfigUtils.put(configJson, ATTR_DEFAULT_VALUE, this.defaultValue);
