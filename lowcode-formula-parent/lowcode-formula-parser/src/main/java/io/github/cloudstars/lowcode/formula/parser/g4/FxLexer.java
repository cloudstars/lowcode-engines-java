...
public class FxLexer extends FxLexerBase {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"OpenParen", "CloseParen", "Comma", "Assign", "Plus", "Minus", "Multiply", 
			"Divide", "Modulus", "LessThan", "MoreThan", "LessThanEquals", "GreaterThanEquals", 
			"WS", "StringLiteral", "DecimalLiteral", "Identifier", "MultiLineComment", 
			"SingleLineComment", "DoubleStringCharacter", "SingleStringCharacter", 
			"DecimalIntegerLiteral", "EscapeSequence", "CharacterEscapeSequence", 
			"SingleEscapeCharacter", "NonEscapeCharacter", "LineContinuation", "IdentifierPart", 
			"IdentifierStart", "UnicodeEscapeSequence", "HexDigit"
		};
	}
