...
public interface JavaScriptParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#objectLiteralStatement}.
	 * @param ctx the parse tree
	 */
	void enterObjectLiteralStatement(JavaScriptParser.ObjectLiteralStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#objectLiteralStatement}.
	 * @param ctx the parse tree
	 */
	void exitObjectLiteralStatement(JavaScriptParser.ObjectLiteralStatementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#leftParenthesis}.
	 * @param ctx the parse tree
	 */
	void enterLeftParenthesis(JavaScriptParser.LeftParenthesisContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#leftParenthesis}.
	 * @param ctx the parse tree
	 */
	void exitLeftParenthesis(JavaScriptParser.LeftParenthesisContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaScriptParser#assignSingleExpression}.
	 * @param ctx the parse tree
	 */
	void enterAssignSingleExpression(JavaScriptParser.AssignSingleExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaScriptParser#assignSingleExpression}.
	 * @param ctx the parse tree
	 */
	void exitAssignSingleExpression(JavaScriptParser.AssignSingleExpressionContext ctx);
	/**
