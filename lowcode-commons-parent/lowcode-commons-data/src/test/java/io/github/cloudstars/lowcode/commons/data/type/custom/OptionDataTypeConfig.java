...
public class OptionDataTypeConfig extends AbstractObjectDataTypeConfig<OptionValue> {
    ...
    @Override
    public OptionValue parseNonNullValue(Object nonNullValue) {
        ...
        return (OptionValue) nonNullValue;
    }
    ...
    @Override
    public void validate(OptionValue nonNullValue) throws InvalidDataException {
