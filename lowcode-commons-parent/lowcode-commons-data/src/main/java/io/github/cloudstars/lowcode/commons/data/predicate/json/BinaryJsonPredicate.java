 ...
 * @author clouds
 */
public class BinaryJsonPredicate extends AbstractTypedConfig implements XJsonPredicate {
    ...
    public BinaryJsonPredicate() {
    }

    public BinaryJsonPredicate(JsonObject configJson) {
        super(configJson);

        this.setType(XJsonPredicate.TYPE_BINARY);
