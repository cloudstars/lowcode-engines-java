 ...
 * @author clouds
 */
public class BinaryJsonExpression extends AbstractConfig implements JsonExpression {
    ...
    private BinaryItem parseItem(JsonObject configJson) {
        String type = (String) configJson.get(ATTR_TYPE);
    ...
    public JsonObject toJson() {
        ...
        configJson.put(ATTR_TYPE, JsonExpression.TYPE_BINARY);
