...
public class DataTypeClassFactory {
    ...
    private static final Map<String, Class<? extends DataTypeConfig>> dataTypeClassMap = new HashMap<>();
     ...
     */
    public static void register(Class<? extends DataTypeConfig> dataTypeClass) {
    ...
    public static Class<? extends DataTypeConfig> get(String dataTypeName) {
        Class<? extends DataTypeConfig> dataTypeClass = dataTypeClassMap.get(dataTypeName);
