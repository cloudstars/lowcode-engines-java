...
public class FileTestUtilsTest {
    ...
    public void testLoadTextFromClassPath() {
        String content = FileTestUtils.loadFileTextFromClasspath("files/file1.txt");
        Assert.assertTrue("{\"abc\":  \"xyz\"}".equals(content));
    }

    @Test
    public void testLoadTextsFromClassPath() {
        Map<String, String> contents = FileTestUtils.loadFileTextsFromClasspath("json/*.json");
    ...
    public void testLoadTextFromLocalPath() {
        ...
        String content = FileTestUtils.loadFileTextFromLocalPath("./pom.xml");
