...
public class JsScriptUtilsTest {
    ...
    public void testExecuteEs6() {
        String script = FileUtils.loadTextFromClasspath("js/es6.js");
    ...
    public void testExecuteIIFE() {
        String script = FileUtils.loadTextFromClasspath("js/iife.js");
        Object result = JsScriptUtils.eval(script);
    ...
    @Test
    public void testF() {
        String script = FileUtils.loadTextFromClasspath("js/f.js");
        Object result = JsScriptUtils.eval(script);
