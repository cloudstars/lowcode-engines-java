...
final class JsDataConverter {
    ...
    public static Object toJavaObject(Value value) {
        ...
        if (value.isNull()) {
            ...
            for (long i = 0, l = value.getArraySize(); i < l; i++) {
                ...
                ((JsonArray) result).add(JsDataConverter.toJavaObject(arrayItemValue));
            }
        } else if (value.hasMembers()) {
            result = new JsonObject<>();
            Set<String> memberKeys = value.getMemberKeys();
            for (String memberKey : memberKeys) {
                ((JsonObject) result).put(memberKey, JsDataConverter.toJavaObject(value.getMember(memberKey)));
            }
    ...
    public static Object toJsObject(Object value) {
        ...
        if (value instanceof Collection) {
            ...
            JsonObject<String, Object> mapObject = new JsonObject<>();
