...
import net.cf.form.engine.oql.ast.expr.identifier.OqlAllFieldExpr;
import net.cf.form.engine.oql.ast.expr.identifier.OqlIdentifierExpr;
import net.cf.form.engine.oql.ast.expr.identifier.OqlNameExpr;
...
public class OqlSelectParser extends OqlExprParser {
    ...
    private void parseSelectList(OqlSelect query) {
        ...
        while (true) {
            OqlExpr selectItemExpr = this.parseSelectItemExpr(null);
