...
public class Keywords {
    ...
    static {
        ...
        Token[] tokens = {
                ...
                Token.CONTAINS, Token.ALL, Token.ANY,
                Token.IN, Token.IS, Token.LIKE,
                Token.NULL, Token.TRUE, Token.FALSE,
                Token.SELECT, Token.FROM, Token.WHERE,
                Token.DISTINCT, Token.AS,
                Token.GROUP, Token.BY, Token.HAVING,
                Token.ORDER, Token.ASC, Token.DESC,
                Token.ESCAPE, Token.LIMIT,
                Token.INSERT, Token.INTO, Token.VALUES,
                Token.UPDATE, Token.SET, Token.DELETE
        };
