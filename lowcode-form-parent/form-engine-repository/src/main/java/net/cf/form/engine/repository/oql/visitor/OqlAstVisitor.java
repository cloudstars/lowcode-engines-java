...
import net.cf.form.engine.repository.oql.ast.OqlCommentHint;
...
import net.cf.form.engine.repository.oql.ast.expr.operation.OqlBinaryOpExprGroup;
...
public interface OqlAstVisitor {
    ...
    /**
     * 是否允许访问 OqlObjectSource 的儿子节点
     *
     * @param x
     * @return
     */
    default boolean visit(OqlObjectSource x) {
        return true;
    }
     ...
     * @param x
     */
    default void endVisit(OqlObjectSource x) {
    }
