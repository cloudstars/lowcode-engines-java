package net.cf.form.engine.repository.oql.util;
...
import net.cf.form.engine.repository.oql.ast.expr.literal.QqlLiteralExpr;
...
public class OqlExprUtils {
    ...
    public static boolean equals(QqlExpr a, QqlExpr b) {
        if (a == b) {
            return true;
    ...
    public static boolean isLiteralExpr(QqlExpr expr) {
        if (expr instanceof QqlLiteralExpr) {
            return true;
     ...
     * @return
     */
    public static QqlExpr parseObject(Object value) {
        if (value == null) {
