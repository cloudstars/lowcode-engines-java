...
import net.cf.form.engine.repository.testcases.statement.insert.AbstractComplexInsertSqlTest;
...
public class ComplexInsertSqlTest extends AbstractComplexInsertSqlTest {

    @Override
    public void testInsertAFromB() {
        super.testInsertAFromB();
    }

    @Override
    protected void testInsertAFromB(String sql) {
        {
            // 通过Druid解析，主要用于调试时对比
